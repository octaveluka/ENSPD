...
/**
 * =====================================================================
 *  ENSPD — Fichier de configuration (EXEMPLE)
 ...
 *       (dans le même dossier : backend-enspd/config.php).
...
return [
    ...
    // Souvent préfixé par votre identifiant cPanel, ex: "moncpanel_enspd".
    'db_name' => 'enspd',
    ...
    // Ex : "https://www.enspd-parakou.bj/backend-enspd".
