<?php
/**
 * Fonctions utilitaires partagées (backend ENSPD) : réponses JSON,
 * validation, limitation de débit, CSRF, garde d'authentification admin,
 * etc.
 *
...
/**
 * Valide une date au format ISO "AAAA-MM-JJ". Retourne true si valide.
 */
...
/**
 * Construit un "slug" URL-safe à partir d'un texte (ex. un titre).
 * Transforme accents, espaces et ponctuation en tirets minuscules.
 */
function slugify(string $text): string
{
    ...
    // Translittération basique des accents si l'extension iconv est là.
...
function start_admin_session(): void
{
    ...
    session_name((string) ($cfg['session_name'] ?? 'ENSPD_ADMIN'));
